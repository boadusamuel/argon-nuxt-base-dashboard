<template>
  <nav
    ...
    data-scroll="true"
  >
    <div class="px-3 py-1 container-fluid" id="navbar-container">
      <AragonBreadcrumbs />
      ...
      <div
        id="navbar"
        class="mt-2 navbar-collapse mt-sm-0 me-md-0 me-sm-4"
      >
        ...
        <div class="navbar-nav justify-content-end">
          <ul class="navbar-nav justify-content-end">
            ...
            <li class="px-3 nav-item d-flex align-items-center" id="configurator">
            ...
            <li class="nav-item dropdown d-flex align-items-center pe-2" id="notification">
              <a
                  id="dropdownMenuButton"
                  href="#"
